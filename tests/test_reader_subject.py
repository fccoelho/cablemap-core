...
_TEST_DATA = (
    ...
    ("SUBJ: GUINEA - U.S./French Meeting with President Compaore \n\nClassified by Charge d'Affaires",
     'GUINEA - U.S./French Meeting with President Compaore'),
    ("SUBJECT: UAE FM DISCUSSES TALIBAN FINANCIAL FLOWS AND REINTEGRATION \nWITH AMB. HOLBROOKE AND TREASURY A/S COHEN\nCLASSIFIED BY: Richard",
     'UAE FM DISCUSSES TALIBAN FINANCIAL FLOWS AND REINTEGRATION WITH AMB. HOLBROOKE AND TREASURY A/S COHEN'),
    ...
    ('SUBJECT: (S) GERMANY TAKING ACTION ON SHIPMENT OF ...', False,
       '(S) GERMANY TAKING ACTION ON SHIPMENT OF ...'),
    ('SUBJECT: (S) GERMANY TAKING ACTION ON SHIPMENT OF ...', True, 
     'GERMANY TAKING ACTION ON SHIPMENT OF ...'),
    ('E.o. 12958: decl: 01/07/2014 Tags: prel, pgov, pins, tu Subject: turkish p.m. Erdogan goes to washington: how strong a leader in the face of strong challenges?\n\n(U) Classifi',
     'turkish p.m. Erdogan goes to washington: how strong a leader in the face of strong challenges?'),
    ...
    ("TAGS: PGOV EINV INRB GM\nSUBJECT: GERMANY/BAVARIA: CSU HOPES FOR FRESH START WITH NEW AND\nYOUNGER FACES IN CABINETAND A DYNAMIC SECRETARY GENERAL \n\n",
     'GERMANY/BAVARIA: CSU HOPES FOR FRESH START WITH NEW AND YOUNGER FACES IN CABINETAND A DYNAMIC SECRETARY GENERAL'),
    ...
    ('TAGS ENRG, EUN, ECON, EIND, KGHG, SENV, SW\nSUBJECT: SWEDISH DEPUTY PM URGES SENIOR USG VISITS TO SWEDEN DURING\nEU PRESIDENCY; WANTS TO LAUNCH U.S.-EU ALERNATIVE ENERGY PARTNERSHIP AT U.S.-EU SUMMIT\nThis is an Action request. Please see para 2.\n',
     'SWEDISH DEPUTY PM URGES SENIOR USG VISITS TO SWEDEN DURING EU PRESIDENCY; WANTS TO LAUNCH U.S.-EU ALERNATIVE ENERGY PARTNERSHIP AT U.S.-EU SUMMIT'),
    ...
    ('SUBJECT: MEMBERS OF CONGRESS DISCUSS BONUSES, BAIL-OUTS AND\nOTHER REFORM MEASURES WITH UK OFFICIALS\n1. (SBU) Summary. Bonuses, regulatory structures',
     'MEMBERS OF CONGRESS DISCUSS BONUSES, BAIL-OUTS AND OTHER REFORM MEASURES WITH UK OFFICIALS'),
    ...
    ('\nSUBJECT: CARDINAL HUMMES DISCUSSES LULA GOVERNMENT, THE OPPOSITION, AND FTAA REF: (A) 05 SAO PAULO 405; (B) 05 SAO PAULO 402 (C) 02 BRASILIA 2670',
      'CARDINAL HUMMES DISCUSSES LULA GOVERNMENT, THE OPPOSITION, AND FTAA'),
    # 06BRASILIA882
    ('SUBJECT: ENERGY INSTALLATIONS REF: BRASILIA 861', 'ENERGY INSTALLATIONS'),
    # 08MOSCOW864
    ...
    ('SUBJECT: GOL DELAYS RELEASING DETAINED HUMAN RIGHTS ACTIVIST FATHI EL-JAHMI REF: A) TRIPOLI 223, B) TRIPOLI 229 \n',
     'GOL DELAYS RELEASING DETAINED HUMAN RIGHTS ACTIVIST FATHI EL-JAHMI'),
    # 05BRASILIA1839
    ('''E.O. 12958: N/A 
TAGS: EAIR EINV
...
1. (SBU) Summary.
''',
     'BRAZIL - NEXT STEPS FOR VARIG UNCLEAR'),
    # 05BRASILIA2806
...
1. (SBU) Summary.''',
     'BRAZILIAN GOVERNMENT INTERVENES IN VARIG - TOO LITTLE, TOO LATE?'),
    # 05TASHKENT284
...
REF:  STATE 105588 ''', True,
     'Grants Support for PD Projects (Iceland)'),
    # 07REYKJAVIK232
    ('''TAGS: OEXC SCUL KPAO IC
...
REF: STATE 184642 ''',
    ...
    ('''SUBJECT: (C/NF) WHO WOULD REPLACE GORDON BROWN AS UK PRIMEREF: A. LONDON 1939  B. LONDON 1704''',
     'WHO WOULD REPLACE GORDON BROWN AS UK PRIME'),
    # 07CAIRO3126
    ('''SUBJECT: SCENESETTER FOR AMBASSADOR CROCKER’S VISIT TO CAIROClassified By: DEPUTY CHIEF OF MISSION STUART JONES. REASONS: 1.4 (B) and (D)\n1. (S) Welcome to Cairo.''',
     'SCENESETTER FOR AMBASSADOR CROCKER’S VISIT TO CAIRO'),
    # 06CAIRO941
...
''',
    '''BAHRAIN WILL FORMALLY REQUEST QATAR TO EXECUTE LEGAL JUDGMENT AGAINST KHALIFA AL SUBAIE'''),
    # 06GENEVA2654
    (r'''E.O. 12958: DECL: 10/16/2016 \
TAGS: PHUM UNHRC
...
SUBJECT: HRC: SPECIAL SESSION ON PALESTINE \
 \
REF: A. A) BERN 1253''',
     '''HRC: SPECIAL SESSION ON PALESTINE'''),
    # 09CAIRO1945
    ('''
SUBJECT:
...
SPP: INFORMATION SHARING ''',
     'TRILATERAL REGULATORY COOPERATION MEETING UNDER SPP: INFORMATION SHARING'),
    # 06BUENOSAIRES579
    ('''E.O. 12958: N/A 
